...
func Test_ClassifyRoot_1(t *testing.T) {
	...
	cr_cases := []classification_result{
		...
		cr_good_from_path("dir", api.Relative, "", "dir"),
		cr_good_from_path("file.ext", api.Relative, "", "file.ext"),

		cr_good_from_path("/", api.SlashRooted, "/", ""),
		cr_good_from_path("/dir", api.SlashRooted, "/", "dir"),
		cr_good_from_path("/file.ext", api.SlashRooted, "/", "file.ext"),
		cr_good_from_path("/dir/", api.SlashRooted, "/", "dir/"),
		cr_good_from_path("/dir/file.ext", api.SlashRooted, "/", "dir/file.ext"),
		...
		cr_good_from_path("a|", api.Relative, "", "a|"),
